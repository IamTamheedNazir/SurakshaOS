        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="footer-description">
              Your trusted partner for Umrah and Hajj journeys. We provide comprehensive packages 
              and services to make your sacred pilgrimage memorable and hassle-free.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/ziyarat-tours">Ziyarat Tours</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-contact">
              <li>
                ...
                <span>123 Main Street, Mumbai, Maharashtra 400001, India</span>
              </li>
              <li>
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                ...
                <a href="mailto:info@umrahconnect.com">info@umrahconnect.com</a>
              </li>
              <li>
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
