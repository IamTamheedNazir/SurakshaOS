      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <p className="footer-description">
            Your trusted partner for Umrah and Hajj journeys. 
            Connecting pilgrims with verified vendors for a blessed experience.
          </p>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/packages?type=ziyarat">Ziyarat Tours</Link></li>
