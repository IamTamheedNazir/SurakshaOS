        ...
        <div className="footer-top">
          ...
          <div className="footer-column">
            ...
            <p className="footer-description">
              India's leading platform for Umrah packages, connecting pilgrims with trusted service providers since 2009.
            </p>
          ...
          <div className="footer-column">
            ...
            <ul className="contact-info">
              ...
              <li>
                <LocationIcon />
                <span>123 Business Center<br />Mumbai, Maharashtra 400001</span>
              </li>
            </ul>
          </div>
        </div>
